...
<body>
	...
	<h1 style="color: black; font-size: 40px;" align="center">we are done with nexus also</h1>
        <h1 style="color: pink; font-size: 40px;" align="center">we are done with nexus also</h1>
         <h1 style="color: jenasena; font-size: 40px;" align="center">we are done with nexus also</h1>
